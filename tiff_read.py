...
inDir = 'content/{/content}/competitions/dstl-satellite-imagery-feature-detection'
...
for imgid in Ids:
    ...
    s1=temp.shape[1]
    s2=temp.shape[2]    
    mask = generate_mask_for_image_and_class((s1,s2),imgid,6,gs,df)
    cv2.imwrite("./Masks/mask_"+imgid+".png",mask*255)
